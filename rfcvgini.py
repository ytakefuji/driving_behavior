...
clf=RandomForestClassifier(criterion='gini',n_estimators=trees, max_depth=None,min_samples_split=2, random_state=54,n_jobs=-1)
scores = cross_val_score(clf, X, y, cv=cv)
print(scores,scores.mean(),round(scores.std(),7))
